...
public class neomessage_eth_t {
  ...
  public void setData(byte[] value) {
    icsneojavaJNI.neomessage_eth_t_data_set(swigCPtr, this, SWIGTYPE_p_unsigned_char.getCPtr(value));
  }

  public byte[] getData() {
    long cPtr = icsneojavaJNI.neomessage_eth_t_data_get(swigCPtr, this);
